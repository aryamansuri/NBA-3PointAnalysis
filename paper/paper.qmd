...
Understanding this link has ramifications for numerous parties, including coaches, players, analysts, and team administration. This study adds to the ongoing debate in the NBA about strategic decision-making and player development by explaining the significance of three-point shooting in deciding game outcomes (@cite-debate). Essentially, the question “Does three point shooting actually lead to team success?”, is being asked.
...
#| echo: false
#| label: fig-2
#| fig-cap: "Scatterplot depicting the **Wins** vs the **3 Points Made** per game"
#| warning: false
